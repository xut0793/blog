...
4. [继往开来（Modernizing JavaScript）](https://mp.weixin.qq.com/s/h3uvL-L1SKuSx17QG7M0cg)，介绍了 2009 年 ES5 与 2015 年 ES6 这两个成功标准背后的故事，主要包括对 ES5 与 ES6 的目标、重大基础更改以及重要新功能的介绍与回顾。
